...
with tab0:
    ...
    s1.metric("Existing 2026 SE", total_current)
    ...
    st.markdown(
        ...
        <div class="leadership-box">
            ...
            <ul>
                ...
                <li>Current installed base: <span class="highlight">{total_current} SE</span>.</li>
    ...
    with exec_col1:
        ...
        product_summary = summary_result.groupby("Product")[["Combined Required Engineers", "Combined Additional Required"]].sum().astype(int).reset_index()
        st.dataframe(product_summary, use_container_width=True)
    with exec_col2:
        st.markdown("### Region Level Requirement")
        region_summary = summary_result.groupby("Region")[["Combined Required Engineers", "Combined Additional Required"]].sum().astype(int).reset_index()
